...
============================================================
ANTI-GENERIC STORY ARCHITECTURE
============================================================
...
- perfect ending
- clean rock-bottom-to-riches arc
- neat lesson reveal
- one heroic decision that fixes everything

Instead build the long-form script from messy ordinary memories:
- awkward conversations
- strange customer requests
- mistakes
- delays
- misunderstandings
- random moments that seem too small to matter
- uncomfortable observations the narrator almost skips over

Long-form section rule:
Every major section must contain at least one concrete scene with:
- location
- specific action
- object or screen
- dialogue, quoted text, or visible reaction

Whenever success, failure, growth, or change appears, attach proof:
- dates
- amounts
- screenshots
- messages
...
If a section starts sounding like a familiar creator comeback story, break the pattern with an ordinary messy detail.
...
- built from specific scenes, proof, memory, and messy ordinary details

NOT AI-generated writing.

Before finalizing, reject and rewrite any section that uses:
- a generic breakthrough
- a miracle first customer
- a perfectly supportive family/spouse moment
- a dramatic bill/emergency as easy stakes
