...
Instead, build the story from unexpected, imperfect, messy details:
...
Every major section must include at least one concrete scene with:
- location
- specific action
- object or screen
...
If the story starts sounding like a familiar creator comeback, break it with an ordinary messy detail.
