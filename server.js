...
const channelRoutes = require("./backend/routes/channelAnalysis");
...
app.use(['/caption', '/analyze', '/api/generate-hooks', '/api/test-hook', '/api/test-script', '/api/generate-image', '/api/generated-images', '/api/channel'], requireApiAuth);
