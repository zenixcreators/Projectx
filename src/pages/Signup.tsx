    ...
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col justify-center items-center p-4 font-sans text-white selection:bg-white/20 selection:text-white">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-[#888888] text-sm">Join Aurora and transform your content</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex gap-3">
            <div className="space-y-1 w-full">
              <label className="text-xs text-[#888888] font-medium ml-1">First name</label>
              <input
                type="text"
                value={firstName}
            ...
            <div className="space-y-1 w-full">
              <label className="text-xs text-[#888888] font-medium ml-1">Last name</label>
              <input
                type="text"
                value={lastName}
